...
namespace shadcnui.GUIComponents.Controls
{
    public class ThemeChanger : BaseComponent
    {
        ...
        public void Draw(ThemeChangerConfig config = null)
        {
            ...
            if (UnityHelpers.Button(buttonText + dropdownIcon, buttonStyle, config.Options ?? new GUILayoutOption[] { GUILayout.Width(config.Width) }))
            {
                ...
                else
                {
                    ...
                    LayerManager.Instance.Open(
                        new LayerConfig
                        {
                            ...
                            Content = () => DrawThemeList(config, themeManager, styleManager),
                        }
                    );
                }
            }
