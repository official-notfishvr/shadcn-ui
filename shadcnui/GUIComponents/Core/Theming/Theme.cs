...
namespace shadcnui.GUIComponents.Core.Theming
{
    public class Theme
    {
        ...
        public static Theme Zinc => new Theme
        {
            Name = "Zinc",
            Base = Hex("#030406"),
        ...
        public static Theme Gray => new Theme
        {
            Name = "Gray",
            Base = Hex("#030303"),
        ...
        public static Theme Stone => new Theme
        {
            Name = "Stone",
            Base = Hex("#0c0a09"),
        ...
        public static Theme Olive => new Theme
        {
            Name = "Olive",
            Base = Hex("#040604"),
        ...
        public static Theme BlueDark => new Theme
        {
            Name = "BlueDark",
            Base = Hex("#050912"),
        ...
        public static Theme Rose => new Theme
        {
            Name = "Rose",
            Base = Hex("#070406"),
        ...
        public static Theme Violet => new Theme
        {
            Name = "Violet",
            Base = Hex("#050409"),
