        ...
        void DrawChartsWindow(int windowID)
        {
            ...
            scroll = gui.ScrollView(
                ...
                () =>
                {
                    ...
                    {
                        new ChartSeries("catA", "Category A", new Color(0.2f, 0.6f, 1f)) { Data = CreateDataPoints("catA", 35) },
                        new ChartSeries("catB", "Category B", new Color(0.3f, 0.8f, 0.4f)) { Data = CreateDataPoints("catB", 25) },
